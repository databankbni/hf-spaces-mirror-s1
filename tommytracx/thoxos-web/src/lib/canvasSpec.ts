...
export const DEFAULT_CANVAS_SPEC: CanvasSpec = {
    tokens: {
        colors: {
            // THOX brand — dark zinc surfaces, emerald accent (no blue/indigo tint)
            bg: '#09090b',
            surface: '#18181b',
            surfaceAlt: '#27272a',
    ...
    components: {
        card: { bg: '#18181b', border: 'rgba(255,255,255,0.06)', radius: '12px', padding: '16px' },
        callout: {
        ...
        table: { headerBg: '#18181b', rowAltBg: 'rgba(255,255,255,0.02)', borderColor: 'rgba(255,255,255,0.06)' },
        codeBlock: { bg: '#09090b', border: 'rgba(255,255,255,0.06)' },
        input: { bg: '#18181b', border: 'rgba(255,255,255,0.08)', focusBorder: '#10b981', radius: '8px' },
        button: {
            primary: { bg: '#10b981', text: '#ffffff', hoverBg: '#34d399' },
