...
export default function SettingsModal({ initialTab = 'providers' }: { initialTab?: Tab }) {
    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                ...
                <p className="text-[11px] text-text-tertiary mb-2">Import from a ThoxOS Web Edition export file</p>
