...
def extract_text(content) -> str:
    ...
    ChatGoogleGenerativeAI sometimes returns `content` as a list of
    content blocks (e.g. [{'type': 'text', 'text': '...'}]) instead of
    a plain string. This flattens it safely so it can be stored in
    ChatMessage / ChatResponse, which expect content: str.
    """
