...
URL = "https://developers.facebook.com/apps/26715819381426213/use_cases/customize/?use_case_enum=FACEBOOK_MESSAGING"
with sync_playwright() as pw:
    ...
    state = {"url": page.url, "text": page.locator("body").inner_text(timeout=15_000)[:16000]}
