...
Generated on: 2025-09-10 17:51:42
...
- [Opentrons API Documentation Structure](#opentrons-api-documentation-structure)
  - [Overview](#overview)
  - [Table of Contents](#table-of-contents)
  - [File-by-File Analysis](#file-by-file-analysis)
    - [1. docs/v2/adapting\_ot2\_flex.rst](#1-docsv2adapting_ot2_flexrst)
    - [2. docs/v2/conf.py](#2-docsv2confpy)
    - [3. docs/v2/deck\_slots.rst](#3-docsv2deck_slotsrst)
    - [4. docs/v2/index.rst](#4-docsv2indexrst)
    - [5. docs/v2/liquid\_class\_definitions.rst](#5-docsv2liquid_class_definitionsrst)
    - [6. docs/v2/liquid\_classes.rst](#6-docsv2liquid_classesrst)
    - [7. docs/v2/moving\_labware.rst](#7-docsv2moving_labwarerst)
    - [8. docs/v2/new\_advanced\_running.rst](#8-docsv2new_advanced_runningrst)
    - [9. docs/v2/new\_atomic\_commands.rst](#9-docsv2new_atomic_commandsrst)
    - [10. docs/v2/new\_complex\_commands.rst](#10-docsv2new_complex_commandsrst)
    - [11. docs/v2/new\_examples.rst](#11-docsv2new_examplesrst)
    - [12. docs/v2/new\_labware.rst](#12-docsv2new_labwarerst)
    - [13. docs/v2/new\_modules.rst](#13-docsv2new_modulesrst)
    - [14. docs/v2/new\_pipette.rst](#14-docsv2new_pipetterst)
    - [15. docs/v2/new\_protocol\_api.rst](#15-docsv2new_protocol_apirst)
    - [16. docs/v2/robot\_position.rst](#16-docsv2robot_positionrst)
    - [17. docs/v2/runtime\_parameters.rst](#17-docsv2runtime_parametersrst)
    - [18. docs/v2/tutorial.rst](#18-docsv2tutorialrst)
    - [19. docs/v2/versioning.rst](#19-docsv2versioningrst)
    - [20. docs/v2/advanced\_control/command\_line.rst](#20-docsv2advanced_controlcommand_linerst)
    - [21. docs/v2/advanced\_control/jupyter.rst](#21-docsv2advanced_controljupyterrst)
    - [22. docs/v2/advanced\_control/motor\_control.rst](#22-docsv2advanced_controlmotor_controlrst)
    - [23. docs/v2/basic\_commands/liquids.rst](#23-docsv2basic_commandsliquidsrst)
    - [24. docs/v2/basic\_commands/pipette\_tips.rst](#24-docsv2basic_commandspipette_tipsrst)
    - [25. docs/v2/basic\_commands/utilities.rst](#25-docsv2basic_commandsutilitiesrst)
    - [26. docs/v2/complex\_commands/order\_operations.rst](#26-docsv2complex_commandsorder_operationsrst)
    - [27. docs/v2/complex\_commands/parameters.rst](#27-docsv2complex_commandsparametersrst)
    - [28. docs/v2/complex\_commands/sources\_destinations.rst](#28-docsv2complex_commandssources_destinationsrst)
    - [29. docs/v2/example\_protocols/dilution\_tutorial.py](#29-docsv2example_protocolsdilution_tutorialpy)
    - [30. docs/v2/example\_protocols/dilution\_tutorial\_flex.py](#30-docsv2example_protocolsdilution_tutorial_flexpy)
    - [31. docs/v2/example\_protocols/dilution\_tutorial\_multi.py](#31-docsv2example_protocolsdilution_tutorial_multipy)
    - [32. docs/v2/example\_protocols/dilution\_tutorial\_multi\_flex.py](#32-docsv2example_protocolsdilution_tutorial_multi_flexpy)
    - [33. docs/v2/modules/absorbance\_plate\_reader.rst](#33-docsv2modulesabsorbance_plate_readerrst)
    - [34. docs/v2/modules/heater\_shaker.rst](#34-docsv2modulesheater_shakerrst)
    - [35. docs/v2/modules/magnetic\_block.rst](#35-docsv2modulesmagnetic_blockrst)
    - [36. docs/v2/modules/magnetic\_module.rst](#36-docsv2modulesmagnetic_modulerst)
    - [37. docs/v2/modules/multiple\_same\_type.rst](#37-docsv2modulesmultiple_same_typerst)
    - [38. docs/v2/modules/setup.rst](#38-docsv2modulessetuprst)
    - [39. docs/v2/modules/stacker.rst](#39-docsv2modulesstackerrst)
    - [40. docs/v2/modules/temperature\_module.rst](#40-docsv2modulestemperature_modulerst)
    - [41. docs/v2/modules/thermocycler.rst](#41-docsv2modulesthermocyclerrst)
    - [42. docs/v2/parameters/choosing.rst](#42-docsv2parameterschoosingrst)
    - [43. docs/v2/parameters/defining.rst](#43-docsv2parametersdefiningrst)
    - [44. docs/v2/parameters/style.rst](#44-docsv2parametersstylerst)
    - [45. docs/v2/parameters/use\_case\_cherrypicking.rst](#45-docsv2parametersuse_case_cherrypickingrst)
    - [46. docs/v2/parameters/use\_case\_dry\_run.rst](#46-docsv2parametersuse_case_dry_runrst)
    - [47. docs/v2/parameters/use\_case\_sample\_count.rst](#47-docsv2parametersuse_case_sample_countrst)
    - [48. docs/v2/parameters/using\_values.rst](#48-docsv2parametersusing_valuesrst)
    - [49. docs/v2/pipettes/characteristics.rst](#49-docsv2pipettescharacteristicsrst)
    - [50. docs/v2/pipettes/loading.rst](#50-docsv2pipettesloadingrst)
    - [51. docs/v2/pipettes/partial\_tip\_pickup.rst](#51-docsv2pipettespartial_tip_pickuprst)
    - [52. docs/v2/pipettes/volume\_modes.rst](#52-docsv2pipettesvolume_modesrst)
...
### 1. docs/v2/adapting_ot2_flex.rst
...
<about>
This is a Sphinx configuration file (`conf.py`) for building the Opentrons Python Protocol API v2 documentation, not a protocol file itself. It configures various documentation build settings including Sphinx extensions (autodoc, napoleon, opengraph, tabs), theme settings (using alabaster theme with custom styling), version information (pulling from the API package version), and documentation metadata. The file sets up intersphinx mapping for Python documentation, configures HTML output options with custom sidebars and styling, LaTeX output settings for PDF generation, and includes extensive nitpick ignore patterns to suppress warnings for internal/undocumented API references. It also defines substitutions for the current API level (2.25) and release version that get automatically inserted throughout the documentation.
</about>

---


### 3. docs/v2/deck_slots.rst
...
### 5. docs/v2/liquid_class_definitions.rst
...
### 8. docs/v2/new_advanced_running.rst
...
### 9. docs/v2/new_atomic_commands.rst
...
### 10. docs/v2/new_complex_commands.rst
...
### 15. docs/v2/new_protocol_api.rst
...
### 17. docs/v2/runtime_parameters.rst
...
### 21. docs/v2/advanced_control/jupyter.rst
...
### 22. docs/v2/advanced_control/motor_control.rst
...
### 23. docs/v2/basic_commands/liquids.rst
...
### 24. docs/v2/basic_commands/pipette_tips.rst
...
### 25. docs/v2/basic_commands/utilities.rst
...
### 26. docs/v2/complex_commands/order_operations.rst
...
### 27. docs/v2/complex_commands/parameters.rst
...
### 28. docs/v2/complex_commands/sources_destinations.rst
...
### 29. docs/v2/example_protocols/dilution_tutorial.py

<about>
This file is a complete serial dilution protocol for the OT-2 robot that demonstrates the outcome of following Opentrons' Python Protocol API Tutorial. It's a single-channel protocol using API level 2.16 that performs a serial dilution by progressively diluting a solution across a 96-well plate. The protocol uses a P300 single-channel pipette (Generation 2) mounted on the left mount. No modules, fixtures, or adapters are used. The labware includes an Opentrons 96-tip rack (300 µL), a NEST 12-well reservoir (15 mL), and a NEST 96-well plate (200 µL flat bottom). While specific liquids aren't named, the protocol works with a diluent (in reservoir well A1) and a sample solution (in reservoir well A2). The protocol steps involve: first distributing 100 µL of diluent to all wells in the plate, then for each of the 8 rows, transferring 100 µL of sample solution to the first well of each row with mixing, followed by serial dilution across the row by transferring 100 µL from each well to the next (columns 1-11) with mixing after each transfer.
</about>

---


### 30. docs/v2/example_protocols/dilution_tutorial_flex.py

<about>
This file is a complete serial dilution protocol for the Opentrons Flex robot, serving as the outcome of following the Python Protocol API Tutorial. It's a protocol file using API level 2.16 for the Flex (OT-3) robot that performs progressive dilution of a solution across a 96-well plate. The protocol uses a Flex 1-channel 1000 µL pipette on the left mount. No modules are used in this protocol. The protocol uses a trash bin fixture (loaded in position A3). No adapters are mentioned. The labware includes an Opentrons Flex 96-tip rack (200 µL tips), a NEST 12-well reservoir (15 mL), and a NEST 96-well plate (200 µL flat bottom). While specific liquids aren't named, the protocol works with a diluent (in reservoir A1) and a solution to be diluted (in reservoir A2). The protocol steps include: (1) distributing 100 µL of diluent to all wells of the plate, (2) transferring 100 µL of solution to the first well of each row with mixing (3 times at 50 µL), and (3) performing serial dilution by transferring 100 µL from each well to the next across 11 wells in each row with mixing after each transfer.
</about>

---


### 31. docs/v2/example_protocols/dilution_tutorial_multi.py

<about>
This file is a serial dilution protocol for the OT-2 robot using an 8-channel pipette, created as the outcome of following the Python Protocol API Tutorial. It's a protocol file with API level 2.16 that performs a serial dilution by progressively diluting a solution stepwise across a 96-well plate. The protocol uses an 8-channel P300 GEN2 pipette mounted on the right side. The labware includes an Opentrons 96-tip rack (300µL), a NEST 12-well reservoir (15mL), and a NEST 96-well plate (200µL flat bottom). The protocol steps involve first distributing 100µL of diluent from reservoir well A1 to all wells in the first row of the plate, then transferring 100µL of solution from reservoir well A2 to the first well of the row with mixing (3 times at 50µL), and finally performing serial dilution by transferring 100µL from each well to the next well across the row (columns 1-11 to columns 2-12) with mixing after each transfer.
</about>

---


### 32. docs/v2/example_protocols/dilution_tutorial_multi_flex.py

<about>
This file is a complete serial dilution protocol for the Opentrons Flex robot using an 8-channel pipette, created as the outcome of following the Python Protocol API Tutorial. It's a protocol file with API level 2.16 designed specifically for the Flex (OT-3) robot, utilizing an 8-channel 1000 µL pipette mounted on the right position. The protocol uses standard labware including Opentrons 96-well tip rack (300 µL), NEST 12-well reservoir (15 mL), and NEST 96-well plate (200 µL flat), along with a trash bin fixture at position A3. The protocol performs a serial dilution by first distributing 100 µL of diluent from reservoir well A1 to all wells in the first row of the plate, then transferring 100 µL of solution from reservoir well A2 to the first well with mixing (3 times at 50 µL), and finally performing stepwise dilution by transferring 100 µL from each well to the next across the row (columns 1-11 to columns 2-12) with mixing after each transfer.
</about>

---


### 33. docs/v2/modules/absorbance_plate_reader.rst
...
### 34. docs/v2/modules/heater_shaker.rst
...
### 35. docs/v2/modules/magnetic_block.rst
...
### 36. docs/v2/modules/magnetic_module.rst
...
### 37. docs/v2/modules/multiple_same_type.rst
...
### 39. docs/v2/modules/stacker.rst
...
### 40. docs/v2/modules/temperature_module.rst
...
### 41. docs/v2/modules/thermocycler.rst
...
### 42. docs/v2/parameters/choosing.rst
...
### 43. docs/v2/parameters/defining.rst
...
### 44. docs/v2/parameters/style.rst
...
### 45. docs/v2/parameters/use_case_cherrypicking.rst
...
### 46. docs/v2/parameters/use_case_dry_run.rst
...
### 47. docs/v2/parameters/use_case_sample_count.rst
...
### 48. docs/v2/parameters/using_values.rst
...
### 49. docs/v2/pipettes/characteristics.rst
...
### 50. docs/v2/pipettes/loading.rst
...
### 51. docs/v2/pipettes/partial_tip_pickup.rst
...
### 52. docs/v2/pipettes/volume_modes.rst
