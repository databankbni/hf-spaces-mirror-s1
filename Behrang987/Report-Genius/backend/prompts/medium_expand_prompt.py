"""Medium AI — delegates to reference_mapper tier routing."""
...
MEDIUM_SYSTEM = compose_mapping_system_prompt("medium")


def build_medium_messages(notes: str, baseline: str) -> list[dict[str, str]]:
...
def build_medium_expand_messages(
    ...
    **_: object,
    ...
    return build_medium_messages(notes, baseline)
