...
SCHEMA_PATH = Path(__file__).resolve().parent.parent / "schemas" / "noaa.json"


class NOAAFormFactory:
    @classmethod
    def create_form(cls, dataset_id: str, data: dict = None) -> forms.Form:
        ...
        form_class = type(f"NOAA_{dataset_id.replace('-', '_').title()}_Form", (forms.Form,), fields)
