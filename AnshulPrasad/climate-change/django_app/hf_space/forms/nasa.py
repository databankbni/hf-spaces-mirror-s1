...
SCHEMA_PATH = Path(__file__).resolve().parent.parent / "schemas" / "nasa.json"


class NASAFormFactory:
    @classmethod
    def create_form(cls, dataset_id: str, data: dict = None) -> forms.Form:
        ...
        form_class = type(f"NASA_{dataset_id.replace('-', '_').title()}_Form", (forms.Form,), fields)
