...
SYMBOLS = [
  "VOO","QQQ","IWM","DIA",
    "LMT","MO","ABBV","XOM","EXC","AMGN","PFE","MCD","UNH","IBM","TMUS","AMT","ABT","MDT",
    "KMI","CVX","LLY","NEE","WMT","GD","COP","CVS","BRK-B","RTX","CMCSA","LIN","UNP","COST",
    "HON","MMM","CSCO","TMO","AIG","LOW","NKE","HD",
    "XEL","AEP","ED","D","ETR","AWK","WEC","ES","CMS","CNP","FE","PPL",
    "AES","EIX","EVRG","LNT","SRE",
    "CAG","GIS","K","HSY","CPB","SJM","MKC","HRL","CLX","KMB","EL","CHD","TSN","KR","SYY",
    "DPZ","UNG","SLV","ZTS","GILD","HUM","CI","ELV","MCK","CAH","ABC",
    "O","ROK","WPC","VICI","BWXT","AVB","EQR","MAA","ARE","PSA","EXR",
    "DLR","EQIX",
    "WM","RSG","ITW","NOC","LHX","AON","MMC","PGR","TRV","CB","ALL","AJG","CINF","AFL","PRU",
    "AAPL","MSFT","GOOGL","GOOG","META","NFLX","ADBE","CRM","ORCL","PYPL","V","MA","TXN",
    "SBUX","INTC","JPM","BAC","WFC","GS","MS","C","BLK","AXP","COF","USB","BK","SCHW","SPG",
    "CAT","FDX","UPS","ACN","GE","EMR","DE","DIS","GM","F","TGT","BKNG",
    "NOW","UBER","LYFT","SQ","SNOW","DDOG","ZS","CRWD","PANW","FTNT","NET","MDB","TEAM",
    "ZM","SPCX","WDAY",
    "AVGO","MRVL","LRCX","KLAC","AMAT","ASML","SNPS","CDNS","ON","MCHP","ADI","NXPI","SWKS","QRVO",
    "ISRG","IDXX","IBKR","ALGM","TSM","FIS","FISV","GPN","INTU","ADP","PAYX",
    "EBAY","ETSY","W","CHWY","DASH","ABNB","EXPE","MAR","HLT","H",
    "DRAM","DD","ECL","APD","SHW","PPG","NEM","FCX",
    "SLB","HAL","BKR","EOG","SKHY","DVN","OXY","MPC","VLO","PSX",
    "TJX","ROST","DG","DLTR","BBY","ORLY","AZO","AAP",
    "PLD","CCI","SBAC","ICE","CME","NDAQ","MSCI","SPGI","MCO",
    "NVDA","AMD","TSLA","AMZN","QCOM","BA",
    "GME","AMC","BB","NOK","GLW","PLTR","SOFI","HOOD","RIVN","LCID",
    "MSTR","COIN","MARA","RIOT","CLSK",
    "IONQ","RGTI","QUBT","SOUN","UPST","AI","PATH","SMCI",
    "NVAX","SRPT",
    "NIO","XPEV","LI","GOEV","FXI",
    "JNJ","RKLB","RDW",
    "RBLX","U","DKNG","RSI",
    "TLRY","CGC","CRON","MU",
    "PLUG","BMY","ENPH",
    "BABA","JD","PDD","BIDU","TME","BILI","IQ","FUTU","TIGR",
    "SHOP","SNAP","PINS","SPOT","TTD","ROKU",
    "CRSP","EDIT","BEAM",
    "ARM","RXRX","SQQQ","UVXY","PL","BBAI","HPQ","AAOI","WDC","GLD","MRNA","KO",
    "YUMC","KHC","FIG","SONY","IREN","CARR","DHI","LSCC","WOLF",
    "MP","ASTS","OPEN","HIMS","VRT","VST","NVO",
    "DUOL","SQM","CRCL","BMNR","DXYZ","DJT",
    "DPST","QMCO","OKLO","ALAB","NBIS","TEM","FFAI",
    "RDDT","OSCR","NVTS","HOLO","UVXY","CRWV","SMR",
    "ONDS","CVNA","KC"
]
...
class StrategyAnalyzer:
    ...
    def _check_breakdown(self, symbol, tf_name, tf_key, df, realtime_price, alerts):
        ...
        period_key = get_period_key(symbol, f"{tf_name}下穿UP2", "抄底", tf_key)
        if period_key not in state.breakdown_triggered:
            state.breakdown_triggered[period_key] = True
            price = realtime_price
            alerts.append(self._make_alert(symbol, f"{tf_name}下穿UP2", "抄底", price, tf_key, 'breakdown', period_key))
