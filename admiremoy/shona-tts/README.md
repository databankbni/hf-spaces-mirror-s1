...
This Space runs a [VITS/MMS](https://huggingface.co/facebook/mms-tts-sna) model
fine-tuned on a small, hand-recorded Shona dataset. It is an early version — the
voice improves as more Shona speech is recorded and the model is retrained.
